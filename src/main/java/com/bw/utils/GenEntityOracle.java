...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/1705ha?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("tbrand","Brand","1705ha").init();  
    }  
}